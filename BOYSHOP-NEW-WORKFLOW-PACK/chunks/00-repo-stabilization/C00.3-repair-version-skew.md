...
## Outcome
Verify canonical VERSION then align only package metadata that genuinely requires it. Do not choose a new version or change unrelated scripts/deps.
