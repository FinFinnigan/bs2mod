# Phase 03 — Builder reconnaissance — Generate tiny chunks
...
Destination:
`chunks/03-builder-reconnaissance/`
...
- contain explicit execution metadata: `ULW: REQUIRED` or `ULW: NOT REQUIRED`; decide this while generating/maintaining the chunk, never at chunk launch;
