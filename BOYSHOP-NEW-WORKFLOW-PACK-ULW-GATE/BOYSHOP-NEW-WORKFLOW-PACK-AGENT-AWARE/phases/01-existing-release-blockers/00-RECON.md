# Phase 01 — Existing release blockers — Reconnaissance

## Routing
Run `ROUTING-PREFLIGHT.md` first. Consider all currently installed OMO agents.

## Mode
READ ONLY.

## Inspect
- authoritative blocker queue
- remaining P0/P1 items
- dependencies
- already-closed versus actually-open items
- approval gates
...
- tests/evidence;
- approval gates;
- repository-derived acceptance criteria.

Do not implement.

At closeout, point `NEXT.md` to this phase's chunk generator.
