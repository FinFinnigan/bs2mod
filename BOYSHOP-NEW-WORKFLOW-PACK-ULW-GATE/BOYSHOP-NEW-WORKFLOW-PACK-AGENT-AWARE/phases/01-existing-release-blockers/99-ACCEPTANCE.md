# Phase 01 — Existing release blockers — Acceptance
...
Confirm all repository-derived acceptance criteria and required tests/evidence.

If incomplete:
- create exactly one missing tiny chunk;
- set NEXT;
- STOP.
...
- point NEXT to next phase reconnaissance;
- STOP.
