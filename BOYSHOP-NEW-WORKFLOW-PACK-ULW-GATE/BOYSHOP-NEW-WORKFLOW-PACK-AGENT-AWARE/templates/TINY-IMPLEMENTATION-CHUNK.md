# CXX.XX — <single behavior>

## Execution mode

ULW: NOT REQUIRED

> Change to `ULW: REQUIRED` only when the pack author/dynamic-maintenance step explicitly classifies this chunk as ULW. Runtime execution must not decide this automatically.
...
## Outcome
One small independently verifiable behavior.

## Scope
Exact small concern and directly related files.

## Out of scope
Adjacent work not allowed.

## Implementation
Smallest safe change.

## Verification
Targeted checks proving the behavior.
