# CXX.XX — <read-only reconnaissance>
...
## Outcome
Establish evidence needed for the next implementation decision.

## Output
Facts, gaps, acceptance criteria, dependencies and approval gates.
