...
import { SortControl } from "@/components/filter/SortControl";
...
export function PlpView({
  ...
  return (
    <div className="container plp-page" style={{ paddingTop: "var(--space-6)" }}>
      <div className="plp-heading" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
        <h1>{title}</h1>
      ...
      <div className="plp-toolbar" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginTop: 8 }}>
      ...
      <div className="plp-content" style={{ display: "flex", gap: "var(--space-8)", marginTop: "var(--space-4)" }}>
        <aside style={{ display: "none", width: 240, flexShrink: 0 }} className="plp-rail plp-filter-rail">
