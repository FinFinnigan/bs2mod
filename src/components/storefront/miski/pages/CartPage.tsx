...
export default function CartPage() {
  ...
  return (
    <div className="container cart-page" style={{ paddingTop: "var(--space-3)" }}>
      ...
      {cart.itemCount === 0 ? (
        ...
        <div style={{ display: "grid", gap: "var(--space-8)", marginTop: "var(--space-4)" }} className="cart-layout">
          ...
          <div className="card-surface cart-summary" style={{ padding: "var(--space-4)", alignSelf: "start", display: "flex", flexDirection: "column", gap: 12 }}>
